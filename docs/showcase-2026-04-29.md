...
| **F. Cutover script + rollback runbook** | partial | Runbook authored at `docs/runbook-rollback.md`. End-to-end capture against a local subtensor not yet recorded — recommend doing this today. |
