"""Cryptographic primitives for hidden-state sketch proofs.
...
def indices_from_root(tokens: list[int], rand_hex: str, seq_len: int, k: int) -> list[int]:
    ...
    from .tokens import int_to_bytes
...
def create_proof(
    ...
    """Generate a deterministic proof package with deterministic indices."""
